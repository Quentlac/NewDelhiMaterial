...
export default function Layout({
  ...
  <div className="flex-1 flex items-center gap-2">
    ...
    <a className="text-xl" href="/">PureDelhiMaterials</a>
    <nav className="ml-4 flex gap-4">
      <a href="/ma-commande?id=15" className="btn btn-ghost btn-sm">Ma commande</a>
      <a href="/stats" className="btn btn-ghost btn-sm">Statistiques</a>
    </nav>
  </div>
